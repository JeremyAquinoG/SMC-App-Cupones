...
app.use('/api/cupones', RouterCupones);
app.use('/api', authRoutes); // Prefijo '/api' para autenticación
app.use('/api', certRoutes); // Prefijo '/api' para certificados
...
const bootstrap = async () => {
  try {
    ...
    await db.sync({ alter: true });  // Esto sincroniza las tablas sin borrar datos
